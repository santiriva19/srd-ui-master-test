...
/**************** Import images ****************/
import imgSearchLogo from '../assets/img/search.svg'
import imgPopex1 from '../assets/img/pope-francis.png'
import imgPopex2 from '../assets/img/pope-francis.@2x.png'
import imgPeoplex1 from '../assets/img/bg-people.png'
import imgPeoplex2 from '../assets/img/bg-people.@2x.png'
...
function Home() {
    ...
    useEffect(()=>{
        const media = window.matchMedia("(min-width: 299px) and (max-width: 499px)");
        ...
        <div>             
                    ...
                    <li>
                        <form action="javascript:void(0)">
                            ...
                            <button className="nav__search icon-button" alt="Search" type="submit">
                                <img src={imgSearchLogo} alt="search"/>
                            </button>
                        </form>
                    </li>
                </ul>
            ...
            <header className="hero"> 
                <img
                    ...
                    srcset= {imgPopex1+" 750w, "+ imgPopex2 +" 1440w"}
                    srcset=  {`${imgPopex2} 1440w`}
                        ...
                        <div className="featured-card__content">
                            ...
                            <div className="featured-card__buttons">
                                <button className="icon-button" aria-label="thumbs up">
                                    <img src={imgThumbUp} alt="thumbs up" />
                                </button>
                                <button className="icon-button" aria-label="thumbs down">
                                    <img src={imgThumbDown} alt="thumbs down" />
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div className = {"contTitleList "+selectValue+"ContTitleList"}>
                <div className = "contTitle">
                    <h1 className = "titlePreviusRuling ">Previous Ruling</h1>
                </div>
            ...
            <main id = "mainContainer" className = {selectValue+"MainContainer"} role="main">
                <div className = "mainAuxiliar">
                    {Data.data.map((element, index) => {
                        return(
                            <CustomCard 
                            index = {index}
                            optionView = {selectValue}
                            name = {element.name} 
            ...
            <aside className="banner banner-bottom" role="doc-tip" aria-label="Submit a name">
                <img
                    srcset={imgPeoplex1+" 750w, "+ imgPeoplex2 +" 1440w"}
                    sizes="(min-width: 750px) 1440px, 100vw"
                    className="banner__background" src={imgPeoplex1}
                    alt=""
                    role="none"/>
                <div className="banner__left">
